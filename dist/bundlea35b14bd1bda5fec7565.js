...
/***/ "./src/scripts/authenticateApi.js":
/*!****************************************!*\
  !*** ./src/scripts/authenticateApi.js ***!
  \****************************************/
...
function authenticateApi(_x, _x2) {
  return _authenticateApi.apply(this, arguments);
}
function _authenticateApi() {
  _authenticateApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(apiUrl, apiKey) {
    var response, record;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (authenticateApi);

/***/ }),

/***/ "./src/scripts/generateFood.js":
/*!*************************************!*\
  !*** ./src/scripts/generateFood.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _authenticateApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./authenticateApi */ "./src/scripts/authenticateApi.js");


// JSONbin with our JSON
var apiKey = '$2b$10$MjLDGc2yCUewqIFpHvHtTOf8QfIVoPGforji6s/KEAX7zimE8hlq.',
  binId = '6481dfb7b89b1e2299abd3f8',
  apiUrl = "https://api.jsonbin.io/v3/b/".concat(binId, "/latest");
...
function generateFood(btnElement) {
  ...
  (0,_authenticateApi__WEBPACK_IMPORTED_MODULE_0__["default"])(apiUrl, apiKey).then(function (data) {
    var filteredArray = '';
    ...
    var food = randomPick(filteredArray);
    populateText(food);
...
function randomPick(filteredArray) {
  var keys = Object.keys(filteredArray);
  var randomKey = keys[Math.floor(Math.random() * keys.length)];
  var randomItem = filteredArray[randomKey];
  return randomItem;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (generateFood);
